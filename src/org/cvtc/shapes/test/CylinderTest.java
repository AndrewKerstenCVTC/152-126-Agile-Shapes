...
public class CylinderTest
{
    ...
    {
        Cylinder cylinder0 = new Cylinder(new MessageBoxSub(), 1, 1);
        assertEquals(12.57, cylinder0.surfaceArea(), 0.1);
        
        Cylinder cylinder1 = new Cylinder(new MessageBoxSub(), 2, 2);
        assertEquals(50.27, cylinder1.surfaceArea(), 0.1);
        
        Cylinder cylinder2 = new Cylinder(new MessageBoxSub(), 3, 3);
    ...
    {
        Cylinder cylinder0 = new Cylinder(new MessageBoxSub(), 1, 2);
    ...
    {
        Cylinder cylinder2 = new Cylinder(new MessageBoxSub(), -1, -1);
    }
    ...
    {
        Cylinder cylinder0 = new Cylinder(new MessageBoxSub(), 1, 1);
        assertEquals(JOptionPane.OK_OPTION, cylinder0.render());
    }
